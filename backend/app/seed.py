...
def _ensure_prediction_columns() -> None:
    ...
    columns = {
        ...
        "institutional_foreign_net": "INTEGER",
        "institutional_trust_net": "INTEGER",
        "institutional_dealer_net": "INTEGER",
        "institutional_total_net": "INTEGER",
        "institutional_intensity": "FLOAT",
        "institutional_tag": "VARCHAR(32)",
        "institutional_reason": "VARCHAR(255)",
