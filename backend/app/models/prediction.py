...
class DailyPrediction(Base):
    ...
    institutional_foreign_net: Mapped[int | None] = mapped_column(Integer, nullable=True)
    institutional_trust_net: Mapped[int | None] = mapped_column(Integer, nullable=True)
    institutional_dealer_net: Mapped[int | None] = mapped_column(Integer, nullable=True)
    institutional_total_net: Mapped[int | None] = mapped_column(Integer, nullable=True)
    institutional_intensity: Mapped[float | None] = mapped_column(Float, nullable=True)
    institutional_tag: Mapped[str | None] = mapped_column(String(32), nullable=True)
    institutional_reason: Mapped[str | None] = mapped_column(String(255), nullable=True)
