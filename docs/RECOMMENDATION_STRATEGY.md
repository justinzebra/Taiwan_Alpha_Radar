...
- 完整 Alpha Score 的價格、技術面與盤後三大法人資料是真實資料，但基本面、新聞與部分籌碼細節目前仍是 mock。
...
| Alpha Score | 五維度綜合評分 | 技術與三大法人真實，其他維度部分模擬 | 展示、架構驗證、輔助觀察 |
...
| 籌碼面 | 三大法人、外資持股、融資變化 | 三大法人官方盤後資料；外資持股與融資變化仍為 mock |
...
3. 增加流動性門檻及異常價格資料檢查。
4. 深化籌碼資料：已接入三大法人盤後買賣超，後續補融資融券並獨立驗證籌碼訊號。
